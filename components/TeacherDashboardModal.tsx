...
const moduleNames: Record<string, { title: string; concept: string; misconception: string }> = {
  fractions: {
    ...
    concept: 'تبدیل اعداد مخلوط، شکستن واحد در تفریق، مدل مساحتی ضرب، سهم‌بندی تقسیم و ساده‌سازی قبل از ضرب',
    misconception: 'تفریق برعکس صورت‌ها، ضرب اعداد مخلوط بدون تبدیل به کسر، و عدم ساده‌سازی قبل از ضرب',
  },
  decimals: {
    title: '۲. سیستم ناوبری (اعشار)',
    concept: 'ارزش مکانی تا مرتبه هزارم، تراز لیزری ممیزها با سپر صفر و پرش ممیز در ضرب توان‌های ۱۰',
    misconception: 'مقایسه نادرست اعشار (بزرگتر دیدن ۰/۰۹۹ از ۰/۳) و تراز کردن اعداد از سمت راست',
  },
  ratios: {
    title: '۳. آزمایشگاه سوخت (تناسب)',
    concept: 'رابطه ضربی تناسب، جدول‌های سه‌ردیفه (تسهیم به نسبت و اختلاف نسبت) و محاسبات درصد تخفیف',
    misconception: 'اعمال رابطه جمعی به جای ضربی، و ناتوانی در محاسبه قیمت پرداختی پس از تخفیف',
  },
  geometry: {
    title: '۴. کارگاه سازه‌ها (هندسه)',
    concept: 'تقارن مرکزی دوران ۱۸۰ درجه، مجموع زوایای مثلث و چهارضلعی، مساحت لوزی/ذوزنقه، تله شعاع در محیط دایره و حجم/لیتر',
    misconception: 'استفاده از شعاع به جای قطر در فرمول ۳/۱۴، فراموشی تقسیم بر ۲ در مساحت، و اشتباه گرفتن خط تقارن با مرکز تقارن',
  },
  statistics: {
    title: '۵. اتاق فرمان (آمار و زمان)',
    concept: 'محاسبات ساعت در مبنای ۶۰ دقیقه، کشف رابطه جبری الگوها و تحلیل معکوس میانگین (مجموع = میانگین × تعداد)',
    misconception: 'قرض گرفتن در مبنای ۱۰۰ به جای ۶۰، و ناتوانی در محاسبه مجموع کل از میانگین',
  },
};
